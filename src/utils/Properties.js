...
class Propreties {
  static getBedrockPropertiesListDB(data) {
    const properties = {
  ...
  static getJavaPropertiesListDB(data) {
    const properties = {
      'server-name': data.name,
      gamemode: data.gamemode,
      'force-gamemode': data.forceGamemode,
  ...
  static syncPropertiesLists(type, path, data) {
    const propertiesListDB = type === 'bedrock' ? Propreties.getBedrockPropertiesListDB(data) : Propreties.getJavaPropertiesListDB(data);
